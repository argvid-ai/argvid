...
1. Start with an approved Ready Issue, public contract/RFC discussion, and synthetic valid/invalid cases. Agree on capability and failure semantics before parallel implementation.
...
Include each field in a handoff:
...
Do not mark unrun HIL passed. Do not put credentials, restricted logs, or material without publication rights in the handoff. Project-specific details belong in [project context](PROJECTS.md), not a separate organizational workflow.
